...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
  ...
  <!-- 
	...
	<div id="fh5co-wrap">
		...
		<div class="fh5co-hero" style="background-image: url(images/logo_1.jpg);" data-stellar-background-ratio="0.1">
			<div class="overlay"></div>
			<div class="container">
				<div class="row">
					<div class="col-md-8 col-md-offset-2 col-sm-12 col-sm-offset-0 col-xs-12 col-xs-offset-0 text-center fh5co-table">
						<div class="fh5co-intro fh5co-table-cell">
							<h1 class="text-center">WARRIORS FRIENDS CLUB</h1>
							<p>Palatuwa</p>
						</div>
					</div>
				</div>
			...
			<div class="row">
				...
				<div class="col-md-3 col-md-push-1">
					...
					<ul class="fh5co-social">
						...
						<li><a href="https://www.facebook.com/maxpalatuwa/"><i class="icon-facebook"></i> <span>Facebook</span></a></li>
